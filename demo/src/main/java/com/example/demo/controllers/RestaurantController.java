...
public class RestaurantController {
    ...
    public ResponseEntity<RestaurantResponse> create(
        ...
        Restaurant saved = restaurantService.createRestaurant(principal.getUserId(), restaurant);
    ...
    public ResponseEntity<RestaurantResponse> toggleStatus(
        ...
        Restaurant updated = restaurantService.toggleOpenStatus(id, principal.getUserId());
